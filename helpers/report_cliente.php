...
class Report extends FPDF
{
    ...
    const CLIENT_URL = 'http://localhost/Muebles.sv/vistas/privada/componentes/';
     ...
     *   Retorno: ninguno.
     */
    public function startReportCliente($title)
    {
        ...
        if (isset($_SESSION['idCliente']) && isset($_SESSION['aliasCliente'])) {
            ...
            // Se añade una nueva página al documento con orientación vertical y formato carta, llamando implícitamente al método headerCliente()
    ...
    public function header()
    {
        ...
        // Se ubica el nombre y ID del cliente.
        $this->cell(20);
        $this->setFont('Arial', '', 10);
        $this->cell(166, 10, 'Generado por: ' . $_SESSION['aliasCliente'], 0, 1, 'C');
