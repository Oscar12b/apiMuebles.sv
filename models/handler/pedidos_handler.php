...
class PedidoHandler
{
    ...
    {
        $sql = 'SELECT p.id_pedido, dp.cantidad_pedido, c.nombre_cliente, p.fecha_pedido, p.fecha_entrega, dp.precio_pedido 
        FROM tb_pedidos p
    ...
    {
        $sql = 'SELECT mu.nombre_mueble, c.nombre_color, m.nombre_material, cat.nombre_categoria, dp.cantidad_pedido, dp.precio_pedido 
